...
Nous allons utiliser la methode LDA (Latent_Dirichlet_Allocation)
...
avec deux parametres importants de la fonction CountVectorizer qui sont:
...
Pour plus de detailles: https://scikit-learn.org/stable/modules/generated/sklearn.feature_extraction.text.CountVectorizer.html
...
"""
topic_results = model_LDA.transform(tf_id)
# Voire la taille
